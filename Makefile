...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/07/25 09:53:55 by lkoekemo          #+#    #+#              #
#    Updated: 2016/11/02 08:10:14 by lkoekemo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_putchar.c ft_putstr.c ft_memset.c \
      ft_bzero.c ft_memcpy.c ft_memccpy.c \
      ft_memmove.c ft_memchr.c ft_memcmp.c \
      ft_strlen.c ft_strcpy.c ft_strncpy.c \
      ft_strdup.c ft_strcat.c ft_strncat.c \
      ...
      ft_strclr.c ft_strmap.c ft_strmapi.c \
